...
using GestioneSagre.Menu.BusinessLayer.Mappers;
...
namespace GestioneSagre.Menu.BusinessLayer.Extensions;
...
public static class RegisterServices
{
    public static IServiceCollection AddRegisterConfigureServices(this IServiceCollection services, IConfiguration configuration, string serviceName, string swaggerName)
    {
        ...
        services.AddAutoMapper(typeof(MenuMapperProfile).Assembly);
        ...
        services.AddDbContextSQLServer<MenuDbContext>(connectionString);
        services.AddTransient<IMenuService, MenuService>();

        services.AddScoped<DbContext, MenuDbContext>();
    ...
    {
        services.AddScoped<IUnitOfWork<Portata>, UnitOfWork<Portata>>();
        services.AddScoped<IRepository<Portata>, Repository<Portata>>();
