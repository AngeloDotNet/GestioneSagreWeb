...
using GestioneSagre.Categorie.BusinessLayer.Mappers;
...
public static class RegisterServices
{
    public static IServiceCollection AddRegisterConfigureServices(this IServiceCollection services, IConfiguration configuration, string serviceName, string swaggerName)
    {
        ...
        services.AddAutoMapper(typeof(CategoriaMapperProfile).Assembly);
        ...
        services.AddDbContextSQLServer<CategorieDbContext>(connectionString);
        services.AddTransient<ICategorieService, CategorieService>();

        services.AddScoped<DbContext, CategorieDbContext>();
    ...
    {
        services.AddScoped<IUnitOfWork<Categoria>, UnitOfWork<Categoria>>();
